"""Subprocess utilities for executing external commands.

This module provides utilities for running external processes in both
detached and query modes. Supports timeouts, encoding control, and
proper process creation flags for Windows.
"""
import logging
import subprocess
