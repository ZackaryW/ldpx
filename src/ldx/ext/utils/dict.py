"""Dictionary utilities for nested and dotted-key manipulation.

This module provides utilities for working with nested dictionaries,
including flattening nested structures to dotted keys and parsing
dotted keys back into nested structures.
"""
