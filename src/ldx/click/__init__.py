...
This module provides the main CLI entry point for the ldx command-line tool.
...
def cli(ctx : click.Context, no_print, ldconsole_path):
    ...
    Main entry point for the ldx CLI tool. Provides access to LDPlayer emulator
    ...
    """
    if no_print:
        import ldx.click.utils_echo as click_override
...
from ldx.click.discover import discover # noqa E402
cli.add_command(discover)

from ldx.click.commands import cmds # noqa E402
