...
Configuration:
    User configuration is stored in ~/.ldx/
    LDPlayer paths are managed in ~/.ldx/ld/config.json
"""

import pathlib

from ldx.core.utils.json import touch_json

# User configuration directory
# User configuration directory
CONFIG_DIR = pathlib.Path.home() / ".ldx"
