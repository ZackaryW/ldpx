"""Macro/script recording file manager.

This module provides the RecordFile class for managing LDPlayer macro/script
recording files. Record files store sequences of touch, swipe, and input
operations that can be replayed on emulator instances.
"""
import json
import os
from dataclasses import asdict
from ldpx.ext.cache import AttrMixin
from ldpx.ext.models.record import Record, RecordInfo, Operation

class RecordFile(AttrMixin):
    """Manager for operation recording (.record) files.
    
    Provides methods to list, load, and save macro/script recordings from
    the operationRecords directory.
