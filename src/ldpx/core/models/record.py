"""Data models for LDPlayer macro/script recording operations.

This module defines data structures for LDPlayer's recording and playback
system, including touch points, operations, and recording metadata.
"""
