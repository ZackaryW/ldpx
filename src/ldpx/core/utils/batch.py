"""Batch execution utilities for running commands on multiple emulator instances.

This module provides the BatchMixin class and batch_execute function for
executing commands across multiple LDPlayer instances. Supports filtering
by indices, names, or custom lambda functions.

Usage:
    Batch operations can target instances by:
    - List of indices: [0, 1, 2]
    - List of names: ["instance1", "instance2"]
    - Lambda filter: lambda x: x.name.startswith('test')
"""
import logging
import time
