"""Process discovery utilities for locating LDPlayer installation.

This module provides automatic discovery of LDPlayer installation directories
by scanning running processes. Useful for finding LDPlayer without manual
configuration.
"""
import psutil
